    ...
    prisma.lawMatter.findMany({
      where: {
        OR: [
          ...
          { participants: { some: { client: { fullName: { contains: query } } } } },
          { participants: { some: { client: { firstName: { contains: query } } } } },
          { participants: { some: { client: { lastName: { contains: query } } } } },
          { participants: { some: { client: { citizenUniqueId: { contains: query } } } } },
        ],
      },
      select: {
        id: true,
        ...
        participants: { select: { client: { select: { fullName: true, citizenUniqueId: true } } }, take: 5 },
      },
      take: 10,
    }),
