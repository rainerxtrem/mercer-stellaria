  ...
  return (
    <main className="brand-shell flex flex-1 justify-center px-6 py-8">
      <div className="mx-auto grid w-full max-w-7xl gap-6">
        ...
        <header className="surface p-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-2 text-sm text-ms-ink/75">{data.client.email} - {data.client.phone ?? "Telephone non renseigne"}</p>
            </div>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <span className="rounded-full border border-ms-gold/45 bg-ms-gold/10 px-3 py-1 text-xs font-semibold text-ms-navy">
              Risque: {data.client.riskLabel ?? "Non evalue"}
            </span>
            <span className="rounded-full border border-ms-navy/20 bg-white px-3 py-1 text-xs font-semibold text-ms-navy">
              Dossier {data.client.isArchived ? "Archive" : "Actif"}
            </span>
          </div>
        </header>

        <section className="grid gap-6 lg:grid-cols-2">
          <SectionBlock title="Contrats" subtitle="Toutes les formules rattachees au client">
        ...
        <SectionBlock title="Historique sinistres" subtitle="Suivi detaille des declarations du client">
